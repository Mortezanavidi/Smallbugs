...
<input type="text" name="Chercher" id="inputChercher" placeholder="<?php echo __('smallbugs.search'); ?>" onkeyup="if(this.value.length > 3) { Cherchons(this.value); } else { document.getElementById('div_ResultatsRech').innerHTML = ''; }" class="inputRech" />
