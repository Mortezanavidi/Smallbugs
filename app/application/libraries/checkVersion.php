<?php
$verActu = Config::get('smallbugs.version');
$verNum = 0;
$verCommit = "";
if (@fopen("https://github.com/mortezanavidi/smallbugsreleases", 'r')) {
	$verDisp = file_get_contents( "https://github.com/mortezanavidi/smallbugsreleases");
