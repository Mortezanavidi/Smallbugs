<?php
	...
	$query .= "WHEN 1 THEN '".__('smallbugs.priority_desc_1')."' ";
	$query .= "WHEN 2 THEN '".__('smallbugs.priority_desc_2')."' ";
	$query .= "WHEN 3 THEN '".__('smallbugs.priority_desc_3')."' ";
	$query .= "WHEN 4 THEN '".__('smallbugs.priority_desc_4')."' ";
	$query .= "WHEN 5 THEN '".__('smallbugs.priority_desc_5')."' ";
	$query .= "ELSE '".__('smallbugs.priority_desc_0')."'";
	$query .= "END AS troi, ";
	$query .= "'' AS quat, ";
	$query .= "'' AS cinq, ";
