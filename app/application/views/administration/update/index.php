<h3>
	<?php echo __('smallbugs.administration_update'); ?>
	<span><?php echo __('smallbugs.administration_update_description'); ?></span>
</h3>
<div class="pad">
...
if (($venant == $valableAdmin  || $venant == $valableUpadte) && isset($_POST["Etape"])) {
	...
	if ($Etape == 1) {
		...
		echo '<li>'.$MyLng["Intro_2"].' <a href="https://github.com/mortezanavidi/smallbugsarchive/'.$verNum.'.zip">github.com/pixeline/bugs/archive/'.$verNum.'</a> </li>';
