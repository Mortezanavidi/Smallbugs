<div id="sidebar_MenuDefault_title" class="sidebarTitles"><?php echo __('smallbugs.active_projects'); ?></div>
<div id="sidebar_MenuDefault" class="sidebarItem">
<h2>
	<?php if(Auth::user()->permission('project-create')): ?>
	<a href="<?php echo URL::to('projects/new'); ?>" class="add" title="New Project" style="margin-top: -18px;"><?php __('smallbugs.new'); ?></a>
	<?php endif; ?>
	<?php 
		///echo __('smallbugs.active_projects');
	?>
	<span><?php echo __('smallbugs.active_projects_description');?></span>
</h2>
