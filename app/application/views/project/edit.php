<h3>
	...
	<?php echo __('smallbugs.update'); ?> <?php echo Project::current()->name; ?>
	<span><?php echo __('smallbugs.update_project_description'); ?></span>
</h3>
<?php
...
<div class="pad">
	...
	<form method="post" action="">
		...
		<table class="form" style="width: 80%;">
			...
			<tr>
				<th><?php echo __('smallbugs.status') ?></th>
				<td><?php echo Form::select('status', array(1 => __('smallbugs.active'), 0 => __('smallbugs.archived')), Project::current()->status); ?></td>
			</tr>
			<tr>
			<th><?php echo __('smallbugs.default_assignee'); ?></th>
				<td>
			...
			<tr>
				<td colspan="2">
				<h3>
				<?php echo __('smallbugs.website_title'); ?>
				</h3>
				</td>
			</tr>
			<tr>
			<th><?php echo __('smallbugs.website_dev'); ?></th>
				<td>
					<input size="50" name="Dev" value="<?php echo @$WebLnk['dev']; ?>" placeholder="http://127.0.0.1/<?php echo Project::current()->name; ?>" />
				</td>
			</tr>
			<tr>
			<th><?php echo __('smallbugs.website_git'); ?></th>
				<td>
			...
			<tr>
			<th><?php echo __('smallbugs.website_prod'); ?></th>
				<td>
			...
			<tr>
				<th></th>
				<td>
					<input type="submit" value="<?php echo __('smallbugs.update'); ?>" />
					<input type="submit" name="delete" value="<?php echo __('smallbugs.delete'); ?> <?php echo Project::current()->name; ?>" onclick="return confirm('<?php echo __('smallbugs.delete_project_confirm'); ?>');" />
				</td>
			</tr>
		</table>
