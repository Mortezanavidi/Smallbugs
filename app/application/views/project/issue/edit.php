<h3>
	<?php echo __('smallbugs.edit_issue'); ?>
</h3>
	...
	<form method="post" action="">
		...
		<table class="form" style="width: 100%;">
			...
			<tr>
				...
				<td>
					<input type="number" name="duration" style="width: 60px;" value="<?php echo Input::old('duration', $issue->duration); ?>" min="1" max="400" />&nbsp;<?php echo __('smallbugs.days'); ?>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<?php echo Form::select('status', array(1=>__('smallbugs.priority_desc_1'),2=>__('smallbugs.priority_desc_2'),3=>__('smallbugs.priority_desc_3'),4=>__('smallbugs.priority_desc_4'),5=>__('smallbugs.priority_desc_5')), $issue->status); ?>
				</td>
			</tr>
			...
			<tr>
				<th></th>
				<td><input type="submit" value="<?php echo __('smallbugs.update_issue'); ?>" class="button primary" /></td>
			</tr>
		</table>
