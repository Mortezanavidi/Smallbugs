...
<h3>
	<?php echo __('smallbugs.create_a_new_issue'); ?>
	<span><?php echo __('smallbugs.create_a_new_issue_in'); ?> <a href="<?php echo $project->to(); ?>"><?php echo $project->name; ?></a></span>
</h3>
...
<div class="pad">
	...
	<form method="post" action="">
		...
		<table class="form" style="width: 100%;">
			<tr>
				<th style="width: 10%"><?php echo __('smallbugs.title'); ?></th>
				<td>
			...
			<tr>
				<th><?php echo __('smallbugs.issue'); ?></th>
				<td>
		...
		<tr>
			<th><?php echo __('smallbugs.tags'); ?></th>
				<td>
			...
			<tr>
				<th><?php echo __('smallbugs.duration'); ?></th>
				<td>
					<input type="number" name="duration" style="width: 60px;" value="<?php echo $config_app['duration']; ?>" min="1" max="400" />&nbsp;<?php echo __('smallbugs.days'); ?>
				</td>
			</tr>

			<tr>
				<th><?php echo __('smallbugs.priority'); ?></th>
				<td>
					<?php echo Form::select('status', array(1=>__('smallbugs.priority_desc_1'),2=>__('smallbugs.priority_desc_2'),3=>__('smallbugs.priority_desc_3'),4=>__('smallbugs.priority_desc_4'),5=>__('smallbugs.priority_desc_5')), 3); ?>
				</td>
			</tr>
			...
			<tr>
				<th><?php echo __('smallbugs.assigned_to'); ?></th>
				<td>
			...
			<?php endif; ?>
			<tr>
				<th><?php echo __('smallbugs.attachments'); ?></th>
				<td>
			...
			<tr>
				<th></th>
				<td><input type="submit" value="<?php echo __('smallbugs.create_issue'); ?>" class="button primary" /></td>
			</tr>
		</table>
...
function IMGupload(input) {
	...
	xhttpUPLD.onreadystatechange = function() {
		...
		if (this.readyState == 4 && this.status == 200) {
			...
			msg = msg + '</a>';
			msg = msg + ((xhttpUPLD.responseText == 0) ? '<?php echo __('smallbugs.fileupload_succes'); ?>' : '<?php echo __('smallbugs.fileupload_failed'); ?>' );
