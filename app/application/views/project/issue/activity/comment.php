<li id="comment<?php echo $comment->id; ?>" class="comment">
	<div class="insides">
		<div class="topbar">
			...
			<?php echo __('smallbugs.commented'); ?> <?php echo date(Config::get('application.my_bugs_app.date_format'), strtotime($comment->updated_at)); ?>
		</div>
		...
		<div class="comment-edit">
			...
			<div class="right">
				<a href="javascript:void(0);" class="action save"><?php echo __('smallbugs.save'); ?></a>
				<a href="javascript:void(0);" class="action cancel"><?php echo __('smallbugs.cancel'); ?></a>
			</div>
		</div>
		<?php endif; ?>
