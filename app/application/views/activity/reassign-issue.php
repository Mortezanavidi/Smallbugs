<li onclick="window.location='<?php echo $issue->to(); ?>';">
	...
	<div class="tag">
		<label class="label warning"><?php echo __('smallbugs.label_reassigned'); ?></label>
	</div>

	<div class="data">
		<a href="<?php echo $issue->to(); ?>"><?php echo $issue->title; ?></a> <?php echo __('smallbugs.was_reassigned_to'); ?>
