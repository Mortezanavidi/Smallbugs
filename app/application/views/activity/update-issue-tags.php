<li onclick="window.location='<?php echo $issue->to(); ?>';">
	...
	<div class="tag">
		<label class="label info"><?php echo __('smallbugs.tag_update'); ?></label>
	</div>
	...
	<div class="data">
		<div class="tag-activity">
			...
			<?php endforeach; ?>
			<?php echo __($tag_counts['added'] > 1 ? 'smallbugs.tags_added' : 'smallbugs.tag_added'); ?>
			<?php echo __('smallbugs.in'); ?>
			...
			<?php endforeach; ?>
			<?php echo __($tag_counts['removed'] > 1 ? 'smallbugs.tags_removed' : 'smallbugs.tag_removed'); ?>
			<?php echo __('smallbugs.in'); ?>
			<a href="<?php echo $issue->to(); ?>"><?php echo $issue->title; ?></a>
			<?php echo __('smallbugs.by'); ?>
			<strong><?php echo $user->firstname . ' ' . $user->lastname; ?></strong>
