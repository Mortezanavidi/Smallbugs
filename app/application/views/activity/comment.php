<li onclick="window.location='<?php echo $issue->to(); ?>#comment<?php echo $comment->id; ?>';">
	...
	<div class="tag">
		<label class="label notice"><?php echo __('smallbugs.label_comment'); ?></label>
	</div>
	...
	<div class="data">
		...
		<strong><?php echo $user->firstname . ' ' . $user->lastname; ?></strong> <?php echo __('smallbugs.on_issue'); ?> <a href="<?php echo $issue->to(); ?>"><?php echo $issue->title; ?></a>
		<span class="time">
