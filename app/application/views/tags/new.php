<h3>
	<?php echo __('smallbugs.create_tag'); ?>
</h3>
...
<div class="pad">
	...
	<form method="post" action="">
		...
		<table class="form" style="width: 100%;">
			<tr>
				<th style="width: 10%"><?php echo __('smallbugs.tag'); ?></th>
				<td>
			...
			<tr>
				<th style="width: 10%"><?php echo __('smallbugs.bgcolor'); ?></th>
				<td>
			...
			<tr>
				<th></th>
				<td><input type="submit" value="<?php echo __('smallbugs.create_tag'); ?>" class="button primary" /></td>
			</tr>
		</table>
