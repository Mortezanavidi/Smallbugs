<h3>
	<?php echo __('smallbugs.your_todos'); ?>
	<span><?php echo __('smallbugs.your_todos_description'); ?></span>
</h3>
<?php
	...
	foreach ($column as $col) {
		...
		if (isset($lanes[$col])) {
			foreach ($lanes[$col] as $lane) {
				...
				echo '			<a class="todo-button del" title="'. __('smallbugs.todos_remove').'" data-issue-id="'.$lane->id.'" href="#">[X]</a>';
