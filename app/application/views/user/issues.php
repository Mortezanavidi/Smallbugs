...
?>
<h3>
	<?php echo __('smallbugs.your_issues'); ?>
	<span><?php echo __('smallbugs.your_issues_description'); ?></span>
</h3>
	...
	<div class="blue-box">
		<div class="inside-pad">
			...
			<ul class="issues">
				...
				<li>
<!-- 
					<a href="#" class="todo-button add" id="issue-id-<?php echo $row->id; ?>" data-issue-id="<?php echo $row->id; ?>" title="<?php echo __('smallbugs.todos_add'); ?>">[+]</a>
 -->
					...
					<div class="data">
						...
						<div class="info">
							...
							- <?php echo __('smallbugs.updated_by'); ?> <strong><?php echo $row->updated->firstname . ' ' . $row->updated->lastname; ?></strong>
