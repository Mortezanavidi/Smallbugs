<div style="display: block ; " id="div_reporttous">
	...
	&nbsp;&nbsp;&nbsp;
	<?php echo __('smallbugs.reports_Production');?>
	</h3>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<b><?php echo __('smallbugs.reports_Filter');?> : </b>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<?php echo __('smallbugs.reports_dteinit');?> : <input type="date" name="DteInit" id="input_DteInit" <?php echo ((isset($_POST["DteInit"])) ? 'value="'.$_POST["DteInit"].'"' : '' ); ?> />
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<?php echo __('smallbugs.reports_dteends');?> : <input type="date" name="DteEnds" id="input_DteEnds" <?php echo ((isset($_POST["DteEnds"])) ? 'value="'.$_POST["DteEnds"].'"' : '' ); ?> />
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<option value="0"><?php echo __('smallbugs.reports_allusers');?></option>
	<?php 
	...
	<div class="stat">
		<div class="stat_element stat_users">
			...
			<b><?php echo count($users); ?> <?php echo __('smallbugs.users');?></b><br />
		</div>	
		<div class="stat_data stat_users_data" onclick="document.getElementById('input_Couleur').value='efd583'; document.getElementById('input_RapType').value='users_list'; document.getElementById('form_reports').submit();">
			...
			<b><?php echo __('smallbugs.reports_allusers');?></b><br />
			<?php echo __('smallbugs.reports_allusersdesc');?>
		...
		<div class="stat_data stat_custom_data" onclick="document.getElementById('input_Couleur').value='dab435'; document.getElementById('div_reportcustom').style.display = 'block'; document.getElementById('div_reporttous').style.display = 'none';" style="margin-top: 150px;">
			...
			<b><?php echo __('smallbugs.reports_custom');?></b><br />
			<?php echo __('smallbugs.reports_customdesc');?>
	...
	<div class="stat">
		<div class="stat_element stat_projects">
			...
			<b><?php echo $projects_total; ?> <?php echo __('smallbugs.projects');?></b><br />
			<br />
			<?php echo $projects_active; ?> <?php echo __('smallbugs.reports_proactive');?> <br />
			<?php echo $projects_inactive; ?>  <?php echo __('smallbugs.reports_proinactive');?> <br />
		</div>	
		<div class="stat_data stat_projects_data" onclick="document.getElementById('input_Couleur').value='79cf9e'; document.getElementById('input_RapType').value='projects_all'; document.getElementById('form_reports').submit();">
			...
			<b><?php echo __('smallbugs.reports_allprojects');?></b><br />
			<?php echo __('smallbugs.reports_allprojectsdesc');?>
		</div>	
		<div class="stat_data stat_projects_data" onclick="document.getElementById('input_Couleur').value='79cf9e'; document.getElementById('input_RapType').value='projects_active'; document.getElementById('form_reports').submit();">
			<img src="../app/assets/images/reports/Stat_projects.png" align="left" />
			<b><?php echo __('smallbugs.reports_allprojects');?></b><br />
			<?php echo __('smallbugs.reports_actprojectsdesc');?>
		</div>	
	</div>
	...
	<div class="stat">
		<div class="stat_element stat_issues">
			...
			<b><?php echo $issues_total; ?> <?php echo __('smallbugs.issues');?></b><br />
			<br />
			<?php echo $issues_active; ?> <?php echo __('smallbugs.reports_issactive');?><br />
			<?php echo $issues_inactive; ?> <?php echo __('smallbugs.reports_issinactive');?><br />
		</div>	
		<div class="stat_data stat_issues_data" onclick="document.getElementById('input_Couleur').value='6ac5e6'; document.getElementById('input_RapType').value='issues_active'; document.getElementById('form_reports').submit();">
			...
			<b><?php echo __('smallbugs.reports_actissues');?></b><br />
			<?php echo __('smallbugs.reports_actissuesdesc');?>
		</div>	
		<div class="stat_data stat_issues_data" onclick="document.getElementById('input_Couleur').value='6ac5e6'; document.getElementById('input_RapType').value='issues_inactive'; document.getElementById('form_reports').submit();">
			<img src="../app/assets/images/reports/Stat_issues.png" align="left" />
			<b><?php echo __('smallbugs.reports_inactissues');?></b><br />
			<?php echo __('smallbugs.reports_inactissuesdesc');?>
		</div>	
		<div class="stat_data stat_issues_data" onclick="document.getElementById('input_Couleur').value='6ac5e6'; document.getElementById('input_RapType').value='issues_progress'; document.getElementById('form_reports').submit();">
			<img src="../app/assets/images/reports/Stat_issues.png" align="left" />
			<b><?php echo __('smallbugs.reports_progissues');?></b><br />
			<?php echo __('smallbugs.reports_progissuesdesc');?>
		</div>	
	</div>
	...
	<div class="stat">
		<div class="stat_element stat_tags">
			...
			<b><?php echo $tags; ?> <?php echo __('smallbugs.tags');?></b><br />
		</div>	
		<div class="stat_data stat_tags_data" onclick="document.getElementById('input_Couleur').value='da7474'; document.getElementById('input_RapType').value='tags_all'; document.getElementById('form_reports').submit();">
			...
			<b><?php echo __('smallbugs.reports_alltags');?></b><br />
			<?php echo __('smallbugs.reports_alltagsdesc');?>
		</div>	
		<div class="stat_data stat_tags_data" onclick="document.getElementById('input_Couleur').value='da7474'; document.getElementById('input_RapType').value='tags_active'; document.getElementById('form_reports').submit();">
			<img src="../app/assets/images/reports/Stat_tags.png" align="left" />
			<b><?php echo __('smallbugs.reports_acttags');?></b><br />
			<?php echo __('smallbugs.reports_acttagsdesc');?>
		</div>	
		<div class="stat_data stat_tags_data" onclick="document.getElementById('input_Couleur').value='da7474'; document.getElementById('input_RapType').value='tags_inactive'; document.getElementById('form_reports').submit();">
			<img src="../app/assets/images/reports/Stat_tags.png" align="left" />
			<b><?php echo __('smallbugs.reports_inacttags');?></b><br />
			<?php echo __('smallbugs.reports_inacttagsdesc');?>
		</div>	
	</div>
	
	<br /><br />
	<h3>
	<?php echo __('smallbugs.reports_archives');?>
	</h3>
	<?php
				...
				foreach($Liste[$col] as $ligne  => $LesDates) {
					foreach ($LesDates as $LaDate => $Fichier) {
						if (isset($Liste[$col][$ligne][$LaDate])) {
							...
							echo '<span style="font-size: 120%; font-weight: bold;">'.(($ligne == 'customized') ? __('smallbugs.reports_custom') : $rappLng[$col]).'</span><br />';
...
<div id="div_reportcustom" style="display: none;">
	...
	<h3>
	<?php echo __('smallbugs.reports_custom');?>
	</h3>
		<table border width="100%">
			...
			<td style="width: 80%; border-style: none; vertical-align: top;">
				<table width="100%"  >
					<tr><td colspan="5" style="color: white; background-color: #003; font-size: 150%; font-weight: bold; text-align: center;" id="td_GdTitre"><?php echo __('smallbugs.reportsCusGdTitre'); ?></td></tr>
					<tr>
						<td style="width: 100%; color: white; background-color: #009; font-size: 115%; font-weight: bold; text-align: center;" id="td_Ex1"><?php echo __('smallbugs.reportsCusTitre'); ?> 1</td>
	...
	<div style="margin-top: 50px; margin-bottom: 50px;">
		...
		<div id="Titre" style="margin-bottom: 20px;">
			<input name="TitreRapport" value="" type="text" size="75" style="background-color: black; color: white;" placeholder="<?php echo __('smallbugs.reportsCusGdTitre');?>" onkeyup="AjourTitre(this.value);" />
		</div>
		<table id="ListColonnes" width="100%"><tr>
			<?php
				for ($col=1; $col<6; $col++) {
					...
					echo '<br />';
					echo '<input name="Titre['.$col.']" id="input_Titre_'.$col.'" value="" placeholder="'.__('smallbugs.reportsCusTitre').' '.$col.'" onkeyup="ChgTitCol('.$col.', this.value);" />';
					echo '<br />';
		...
		<tr>
			<td style="padding: 5px;">
				...
				foreach($results as $result) {
					echo '<option value="'.$result->id.'" '.(($result->status == 1) ? 'selected="selected"' : '').' >'.$result->name.' '.(($result->status == 1) ? '' : ' ( '.__('smallbugs.archived').' ) ').'</option>';
				}
				?>
				</select>
			</td>
...
<script type="text/javascript" >
	...
	function AjourTitre(valeur) {
		if (valeur == '') {
			document.getElementById('td_GdTitre').innerHTML = "<?php echo __('smallbugs.reportsCusGdTitre'); ?>";
		} else {
